<div class="page-content">
    ...
    <section class="page-content__section">
        ...
        <dl>
            <dt>Custom Aliases</dt>
            <dd>Replace random characters with a memorable, branded short name (e.g., <code>qurl.pp.ua/my-event</code>). Your links, your brand.</dd>

            <dt>Multiple Domain Options</dt>
            <dd>Choose from a curated list of domains to find the one that best fits your needs, whether it's for professional use, gaming communities, or personal projects.</dd>

            <dt>Password Protection</dt>
            <dd>Secure your content by adding an access password to your short links. Only users with the password will be able to reach the destination URL.</dd>

            <dt>Link Preview Page</dt>
            <dd>Build trust with your audience. Enable a preview page that shows visitors a custom note and the destination URL before they are redirected, eliminating surprises.</dd>

            <dt>Link Management & Statistics</dt>
            <dd>Protect your link settings with an admin password. Use it to access a private statistics page to see how many clicks your link has received.</dd>
