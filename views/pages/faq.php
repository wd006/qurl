<div class="faq-wrapper">
    ...
    <div class="faq-category">
        ...
        <details class="faq-item">
            <summary>Is this service completely free?</summary>
        ...
        <details class="faq-item">
            <summary>Do my shortened links expire?</summary>
            <div class="faq-content">
    ...
    <div class="faq-category">
        ...
        <details class="faq-item">
            <summary>Can I customize my short link?</summary>
            <div class="faq-content">
        ...
        <details class="faq-item">
            <summary>Can I password-protect my links?</summary>
            <div class="faq-content">
        ...
        <details class="faq-item">
            <summary>What is the "Info Page" feature?</summary>
            <div class="faq-content">
        ...
        <details class="faq-item">
            <summary>Can I edit or delete a link later?</summary>
            <div class="faq-content">
    ...
    <div class="faq-category">
        ...
        <details class="faq-item">
            <summary>Is <?= CONFIG['name'] ?> safe to use?</summary>
            <div class="faq-content">
        ...
        <details class="faq-item">
            <summary>Do you offer an API for developers?</summary>
            <div class="faq-content">
        ...
        <details class="faq-item">
            <summary>Why do I see a CAPTCHA?</summary>
            <div class="faq-content">
